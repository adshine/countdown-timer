        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label 
                htmlFor="hours" 
                className={`block text-sm font-medium ${activeInput === 'hours' ? 'text-[#0000FF]' : 'text-gray-300'} mb-1`}
              >
                Hours
              </label>
              <input
                ...
                min="0"
                max="24"
                className={`w-full bg-background border ${activeInput === 'hours' ? 'border-[#0000FF]' : 'border-gray-700'} rounded-lg p-3 text-white`}
            ...
            <div>
              <label 
                htmlFor="minutes" 
                className={`block text-sm font-medium ${activeInput === 'minutes' ? 'text-[#0000FF]' : 'text-gray-300'} mb-1`}
              >
                Minutes
              </label>
              <input
                ...
                min="0"
                max="59"
                className={`w-full bg-background border ${activeInput === 'minutes' ? 'border-[#0000FF]' : 'border-gray-700'} rounded-lg p-3 text-white`}
                aria-describedby={error ? 'form-error' : undefined}
              />
            </div>
          </div>
